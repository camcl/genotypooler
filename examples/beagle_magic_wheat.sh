...
java -Xss5m -jar $beaglejar impute=false gtgl=Chr$chrom.SNPs.pruned.nomiss.pooled.vcf.gz map=1_interpolated_wheat_map_plink.map out=Chr$chrom.SNPs.pruned.nomiss.pooled.unphased
...
echo ''
java -Xss5m -jar $beaglejar impute=false gt=Chr$chrom.SNPs.pruned.nomiss.pooled.unphased.vcf.gz map=1_interpolated_wheat_map_plink.map out=Chr$chrom.SNPs.pruned.nomiss.pooled.phased
